...
import ChampionParticipantProfile from "./pages/champions/portal/ChampionParticipantProfile";
    ...
    <AlertProvider>
      <BrowserRouter>
        <Routes>
          ...
          <Route
            path={ROUTES.championParticipantProfile}
            element={
              <ProtectedRoute championOnly>
                <ChampionParticipantProfile />
              </ProtectedRoute>
            }
          />
